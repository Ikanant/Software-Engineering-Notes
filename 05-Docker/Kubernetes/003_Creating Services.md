...
***Service:*** [A Service provides a single point of entry for accessing one or more Pods.]
...
The answer will shock you... We can simply just exec to shell into the Pod/Container and send a [curl] command against the Pod IP that we want to call.
