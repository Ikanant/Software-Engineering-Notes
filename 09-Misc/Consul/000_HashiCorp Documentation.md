...
After a succesful installation we need to run Consul in **either** SERVER or CLIENT mode. Each DC (datacenter) most have at least ONE server. [A single SERVER deployment is HIGHLY discouraged.]
