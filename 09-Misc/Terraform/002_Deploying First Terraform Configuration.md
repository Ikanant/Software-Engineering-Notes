...
5.  *\>\>\> Later in the config we will also have to setup ROUTING resources and a SECURITY group to [allow] web traffic to reach that web-server*
...
**[I really should re-watch the Reviewing the Base Configuration section of the course]**
